...
vl <- list(
  common = c(
    ...
    "pid7others.5" = "3-pt Party ID Leaners: Lean Republican",
    "gender.2" = "Gender",
    "race.2" = "Black",
    "race.3" = "Hispanic",
    "race.4" = "Asian",
...
vl[["var18"]] <- c(
  ...
  "CC18_301.6" = "Not sure whether national economy has gotten better/worse",
...
vl[["var14"]] <- c(
  ...
  "CC14_331_3.2" = "Would fund NSA's program that collects details on every phone call",
...
vl[["var12"]] <- c(
  ...
  "CC326.2”" = "Oppose a Constitutional Amendment banning gay marriage",
  "CC327.4" = "Strongly opposes affirmative action",
  "CC328.2" = "Prefer Congress to cut domestic spending for balanced budget",
  "CC332E.2" = "Oppose Elena Kagan to the SCOTUS",
  "CC332G.2" = "Oppose gays openly serving in the armed services",
  ...
  "CC421_rep.999" = "Does not think of themself as a Republican",
...
vl[["var10"]] <- c(
  ...
  "cc308a.4" = "Strongly disapprove of Obama's job",
  "cc308a.2" = "Somewhat approve of Obama's job",
  ...
  "cc332a.2" = "Oppose American Recovery and Reinvestment Act",
  "cc332d_oppose" = "Oppose Comprehensive Health Reform Act",
  "cc332d.2" = "Oppose Comprehensive Health Reform Act",
  "cc332e_oppose" = "Oppose appointing Elena Kagan to the U.S. Supreme Court",
  "cc332e.2" = "Oppose appointing Elena Kaga to the U.S. Supreme Court",
  ...
  "cc350.3" = "Registered with the Republican Party",
  "cc355_sen_cand_name2_republican" = "Prefers Republican candidate for US Senate",
  "cc355.2" = "Prefers Republican candidate for US Senate",
  ...
  "cc390.2" = "Prefers Republican House Candidate",
  ...
  "cc424.5" = "Very Negative Opinion of Tea Party",
  "v212a_republican" = "Think of myself as Republican",
  "v212a.2" = "3-pt Party ID: Republican",
  "v212d.7" = "Strong Republican",
  "v212d.5" = "Lean Republican",
  "v212d.6" = "Not very strong Republican", 
  "v212d.4" = "Independent",
  "v212d.3" = "Lean Democrat",
  "v212d.2" = "Not very strong Democrat"
) %>%
  c(vl$common, .)
...
vl[["var08"]] <- c(
  ...
  "cc307a.5" = "Lean Republican",
  "cc307a.6" = "Not very strong Republican",
  "cc307a.3" = "Lean Democrat",
  "cc307a.4" = "Independent",
  "cc307a.2" = "Not very strong Democrat",
  "cc309.2" = "Governor, Senators, and Representative are Republicans",
  "cc310a.2" = "Least wants Congress to Cut Domestic Spending",
  "cc313.4" = "Strongly Oppose Affirmative Action",
  "CC316a.2" = "Opposes withdrawing troops from Iraq within 180 days",
  "cc316c.2" = "Oppose Federal Funding of Embryonic Stem Cell Research",
  "cc316e.2" = "Opposes a Health Insurance Program for Children",
  "cc316f.2" = "Oppose Amendment to Ban Gay Marriage",
  ...
  "CC317I_BO.2" = "Does Not Consider Obama Knowledgeable",
  ...
  "CC323_2.3" = "Would prefer Barack Obama & Rep Congress second to last",
  "CC323_2.4" = "I would least prefer Obama & Rep Congress",
  "CC323_3.4" = "I would least prefer McCain & Rep Congress",
  "CC323_4.3" = "Would prefer John McCain & Dem Congress second to last",
...
vl[["anes"]] <- c(
  ...
  "vcf0345_4" = "(President- Cares: 4 Not well at all)",
  "vcf0348_2" = "President does not make me hopefull",
  "vcf0349_2" = "(President− Proud: 2. No, haven't felt (1980,1982 only: DK))", 
  ...
  "vcf0387d_999" = "(1952−1968 Mention 1: Like About Republican Party COLLAPSED: answer missing)",
  ...
  "vcf0481_5" = "(Dislikes anything about Democratic Presidential Candidate 5. No)",
  "vcf0482b_999" = "(1972−2004 Mention 1: Dislike About Democratic Presidential Cand COLLAPSED: answer missing)",
  "vcf0482d_999" = "(Particular dislike about Dem prez cand: answer missing)",
  "vcf0438d_999" = "(1952−1968 Mention 2: Dislike About Democratic Presidential Cand COLLAPSED: answer missin)",
  ...
  "vcf0494d_999" = "(1952−1968 Mention 1: Dislike About Republican Presidential Cand COLLAPSED: answer missing)", 
  ...
  "vcf0622_3" = "Govt pays a good deal (3) of attention to what people think",
  ...
  "vcf0738_5" = "(Party of registration Post-election: 5. Republican party)",
